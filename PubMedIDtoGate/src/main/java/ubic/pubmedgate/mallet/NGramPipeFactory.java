...
public class NGramPipeFactory {
    public static Pipe getNGramPipe( String name, File inputFile, boolean ignoreCase, int gram ) throws Exception {
        ...
        bw.close();
        br.close();
        return new TrieLexiconMembership( name + "-" + gram + "-gram", tempFile, ignoreCase );
    }
    ...
    public static String[] getGrams( String s, int n ) {
        ...
        if ( tokens.countTokens() < n ) return null;
    ...
    /*
     * Get a list of pipes that correspond to lexicons for 1-6 grams of the tokenized lexicon contained in the inputFile
     */
    public static List<Pipe> getAllGramsPipes( String name, File inputFile, boolean ignoreCase ) throws Exception {
        return getAllGramsPipes( name, inputFile, ignoreCase, 1 );
    }

    public static List<Pipe> getAllGramsPipes( String name, File inputFile, boolean ignoreCase, int startGramSize )
            throws Exception {
        // go up to seven?
