...
/**
 * This class illustrates how to use ANNIE as a sausage machine in another application - put ingredients in one end
 * (URLs pointing to documents) and get sausages (e.g. Named Entities) out the other end.
 * <P>
 * <B>NOTE:</B><BR>
...
public class StandAloneAnnie {
    ...
    /**
     * Initialise the ANNIE system. This creates a "corpus pipeline" application that can be used to run sets of
     * documents through the extraction system.
     */
     ...
     * <P>
     * <B>NOTE:</B><BR>
     * This code will run with all the documents in memory - if you want to unload each from memory after use, add code
     * to store the corpus in a DataStore.
     */
        ...
        public boolean addSortedExclusive( Annotation annot ) {
            ...
            for ( int i = 0; i < size(); ++i ) {
                ...
                if ( annotStart < currStart ) {
                    ...
                    /*
                     * Out.prln("Insert start: "+annotStart+" at position: "+i+" size="+size()); Out.prln("Current
                     * start: "+currStart);
                     */
                    return true;
                } // if
